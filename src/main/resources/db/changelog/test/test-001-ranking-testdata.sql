...
insert into ranking (id, dtbid, firstname, lastname, federation, club, nationality, period, gender, yob, points, rankOverall) values (2, 10812346, 'Maik', 'Mustermann', 'WTV', 'Musterhausener TC', 'GER', '2020-03-31', true, 2008, '21,2', 1887);