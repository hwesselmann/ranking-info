...
import de.hdawg.rankinginfo.app.model.listing.ListingItem;
...
public class ListingService {
  ...
  /**
   * retrieve the age group rankings from the datastore and map them to the json structure for the
   * clients.
   *
   * @param rankingPeriod    ranking period
   * @param ageGroup         age group
