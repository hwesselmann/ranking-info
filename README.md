...
All API endpoints are under `/api/v1` and require Bearer token authentication. A gRPC equivalent (`RankingService`, `PlayerService`, `ClubService`) is also available on port 9090.
